...
Tinytest.add('escapeHtmlString - escape', function(test) {
  ...
  test.equal(Blaze.escapeHtmlString(1), '', 'Expected values to be equal')
  test.equal(Blaze.escapeHtmlString(1, v), '&lt;script&gt;alert(123)&lt;/script&gt;', 'Expected values to be equal')
});
